...
function StarterIsland() {
  return (
    <g>
      ...
      <ellipse cx="60" cy="65" rx="35" ry="18" fill="#FF9E1B" opacity="0.3" />
      ...
      <motion.circle
        cx="60" cy="54" r="4" fill="#58CC02" opacity="0.6"
      ...
      <path d="M77,45 L70,50 L84,50 L77,45Z" fill="#58CC02" opacity="0.25" />
      {/* Map marker */}
      <motion.circle cx="82" cy="38" r="5" fill="none" stroke="#58CC02" strokeWidth="1.5"
        animate={{ y: [-2, 2, -2] }}
      ...
      {[0, 1, 2].map((row) =>
        [0, 1, 2].map((col) => (
          <rect
            ...
            fill={row === 1 && col === 1 ? "#58CC02" : "#FF9E1B"}
  ...
  return (
    <g>
      ...
      <motion.path
        ...
        stroke="#FF9E1B" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"
  ...
  return (
    <g>
      ...
      <motion.g animate={{ scale: [1, 1.05, 1] }} transition={{ duration: 3, repeat: Infinity }}>
        <ellipse cx="60" cy="42" rx="10" ry="8" fill="none" stroke="#58CC02" strokeWidth="1.5" opacity="0.5" />
        <circle cx="58" cy="41" r="3" fill="#58CC02" opacity="0.4" />
        <circle cx="62" cy="41" r="3" fill="#58CC02" opacity="0.4" />
      </motion.g>
...
function ExpandingRealm() {
  return (
    <g>
      ...
      <ellipse cx="60" cy="65" rx="30" ry="11" fill="#FF9E1B" opacity="0.3" />
      ...
      <polygon points="43,50 38,58 48,58" fill="#58CC02" opacity="0.4" />
      <rect x="72" y="54" width="14" height="18" rx="2" fill="#7A6554" opacity="0.6" />
      <polygon points="79,46 72,54 86,54" fill="#58CC02" opacity="0.5" />
      {/* XP stars collecting */}
      {[[30, 50], [90, 48], [55, 40], [100, 55]].map(([x, y], i) => (
        <motion.text key={i} x={x} y={y} fontSize="8" fill="#58CC02" opacity="0.5"
      ...
      {/* Expansion arrows */}
      <path d="M18,65 L10,65 M22,68 L10,68" stroke="#58CC02" strokeWidth="1.5" strokeLinecap="round" opacity="0.3" />
      <path d="M102,65 L110,65 M98,68 L110,68" stroke="#58CC02" strokeWidth="1.5" strokeLinecap="round" opacity="0.3" />
    </g>
  );
}
...
function FullWorld() {
  return (
    <g>
      ...
      {/* Large terrain */}
      <ellipse cx="60" cy="68" rx="44" ry="16" fill="#FF9E1B" opacity="0.25" />
      ...
      {/* Sun */}
      <motion.circle cx="90" cy="24" r="8" fill="#58CC02" opacity="0.25"
