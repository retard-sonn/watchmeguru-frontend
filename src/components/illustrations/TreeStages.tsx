...
export function SeedStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      <rect x="26" y="50" width="28" height="18" rx="3" fill="#58CC02" opacity="0.3" stroke="#46A302" strokeWidth="1.5"/>
      <rect x="30" y="54" width="20" height="10" rx="2" fill="#46A302" opacity="0.2"/>
      <path d="M32,50 Q40,40 48,50" fill="#FF9E1B" opacity="0.4"/>
      <line x1="40" y1="48" x2="40" y2="44" stroke="#FF9E1B" strokeWidth="1.5" strokeLinecap="round"/>
      <ellipse cx="38" cy="43" rx="4" ry="5" fill="#FF9E1B" opacity="0.6"/>
...
export function SproutStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      <ellipse cx="40" cy="68" rx="16" ry="4" fill="rgba(0,0,0,0.06)"/>
      <rect x="28" y="52" width="24" height="16" rx="3" fill="#58CC02" opacity="0.3" stroke="#46A302" strokeWidth="1.5"/>
      <path d="M38,52 Q36,32 40,30" stroke="#FF9E1B" strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M40,30 Q44,36 46,42" stroke="#FF9E1B" strokeWidth="2" strokeLinecap="round"/>
      <ellipse cx="35" cy="32" rx="8" ry="5" fill="#58CC02" opacity="0.7" transform="rotate(-30,35,32)"/>
      <ellipse cx="46" cy="38" rx="7" ry="4.5" fill="#FF9E1B" opacity="0.6" transform="rotate(20,46,38)"/>
...
export function SaplingStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      <rect x="30" y="56" width="20" height="14" rx="3" fill="#58CC02" opacity="0.3" stroke="#46A302" strokeWidth="1.5"/>
      ...
      <ellipse cx="45" cy="32" rx="9" ry="5.5" fill="#FF9E1B" opacity="0.7" transform="rotate(25,45,32)"/>
      ...
      <circle cx="44" cy="30" r="1.5" fill="#FF9E1B" opacity="0.3"/>
    </svg>
  );
}
...
export function TreeStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      <ellipse cx="32" cy="28" rx="12" ry="10" fill="#FF9E1B" opacity="0.5" transform="rotate(-20,32,28)"/>
...
export function ForestStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      <ellipse cx="40" cy="18" rx="20" ry="16" fill="#FF9E1B" opacity="0.5"/>
      ...
      <circle cx="46" cy="20" r="2" fill="#58CC02" opacity="0.3"/>
    </svg>
  );
}
...
export function WorldTreeStage({ size = 80 }: { size?: number }) {
  ...
  return (
    <svg ref={ref} width={size} height={size} viewBox="0 0 80 80" fill="none">
      ...
      {/* Canopy layers */}
      <ellipse cx="40" cy="14" rx="22" ry="16" fill="#FF9E1B" opacity="0.45"/>
      ...
      {/* Fruit/stars */}
      <circle cx="34" cy="12" r="2.5" fill="#58CC02" opacity="0.5"/>
      <circle cx="48" cy="16" r="2.5" fill="#FFC800" opacity="0.4"/>
      <circle cx="30" cy="22" r="2" fill="#58CC02" opacity="0.4"/>
