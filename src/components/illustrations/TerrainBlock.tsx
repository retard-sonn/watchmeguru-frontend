...
function Consistency() {
  return (
    <g>
      ...
      <path d="M30,95 Q55,82 80,86 Q105,90 130,95 L130,108 Q105,110 80,107 Q55,104 30,108Z" fill="#7BA65B" opacity="0.5" />
      ...
      {[50, 65, 80, 95, 110].map((x, i) => (
        <g key={i}>
          ...
          <ellipse cx={x} cy={63} rx="4" ry="5" fill="#7BA65B" className="anim-leaf" style={{ animationDelay: `${i * 0.2}s` }} />
        </g>
      ))}
      {/* Tree rings on side */}
      <g transform="translate(32, 68)">
        <circle cx="0" cy="0" r="12" fill="none" stroke="#D9A441" strokeWidth="1.5" opacity="0.4" />
        <circle cx="0" cy="0" r="8" fill="none" stroke="#D9A441" strokeWidth="1" opacity="0.3" />
        <circle cx="0" cy="0" r="4" fill="none" stroke="#D9A441" strokeWidth="0.8" opacity="0.5" />
      </g>
      {/* Tiny path */}
...
function Focus() {
  return (
    <g>
      ...
      {/* Isolated chamber */}
      <rect x="65" y="60" width="30" height="35" rx="4" fill="#7BA65B" opacity="0.3" />
...
function Momentum() {
  return (
    <g>
      ...
      <path d="M80,95 Q110,90 145,95" stroke="#7BA65B" strokeWidth="2" fill="none" opacity="0.35" />
      {/* Acceleration arrows */}
      <motion.path
  ...
  return (
    <g>
      ...
      <motion.g animate={{ opacity: [0.7, 1, 0.7] }} transition={{ duration: 2, repeat: Infinity }}>
        <rect x="76" y="78" width="8" height="4" rx="1" fill="#D9A441" />
        <circle cx="80" cy="80" r="6" fill="#D9A441" opacity="0.4" />
      ...
      {/* Wall sconces */}
      <circle cx="58" cy="85" r="3" fill="#D9A441" opacity="0.3" />
      <circle cx="102" cy="85" r="3" fill="#D9A441" opacity="0.3" />
      {/* Protection barrier symbols */}
      <path d="M40,75 L40,95" stroke="#7BA65B" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.35" />
      <path d="M120,75 L120,95" stroke="#7BA65B" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.35" />
    </g>
  );
}
...
function XP() {
  return (
    <g>
      <ellipse cx="80" cy="112" rx="60" ry="10" fill="rgba(91,70,54,0.08)" />
      {/* Base terrain */}
      <path d="M20,100 Q50,90 80,95 Q110,100 140,95 L140,105 Q110,110 80,105 Q50,100 20,105Z" fill="#7BA65B" opacity="0.3" />
      {/* Tower 1 — small */}
      ...
      <rect x="57" y="55" width="14" height="8" rx="2" fill="#D9A441" opacity="0.5" />
      <motion.circle
      ...
      <rect x="103" y="44" width="16" height="10" rx="2" fill="#D9A441" opacity="0.6" />
      ...
      {/* Unlock glow */}
      <motion.circle
        cx="64" cy="59" r="8" fill="#D9A441" opacity="0.08"
        animate={{ r: [8, 14, 8], opacity: [0.08, 0, 0.08] }}
        transition={{ duration: 3, repeat: Infinity }}
      />
      {/* Expansion arrows */}
      <path d="M15,85 L10,85 M18,88 L10,88" stroke="#D9A441" strokeWidth="1.5" strokeLinecap="round" opacity="0.3" />
      <path d="M145,85 L150,85 M142,88 L150,88" stroke="#D9A441" strokeWidth="1.5" strokeLinecap="round" opacity="0.3" />
    </g>
  );
}
...
function Community() {
  return (
    <g>
      ...
      {/* Island 1 */}
      <ellipse cx="40" cy="95" rx="22" ry="10" fill="#7BA65B" opacity="0.3" />
      ...
      {/* Island 2 */}
      <ellipse cx="80" cy="100" rx="28" ry="12" fill="#7BA65B" opacity="0.35" />
      <ellipse cx="80" cy="100" rx="22" ry="9" fill="#5F8C3E" opacity="0.4" />
      {/* Village on island 2 */}
      <rect x="73" y="80" width="14" height="17" rx="2" fill="#7A6554" opacity="0.55" />
      <polygon points="80,72 73,80 87,80" fill="#D9A441" opacity="0.5" />
      {/* Island 3 */}
      <ellipse cx="120" cy="95" rx="20" ry="9" fill="#7BA65B" opacity="0.3" />
      ...
      <motion.g animate={{ opacity: [0.4, 0.8, 0.4] }} transition={{ duration: 2.5, repeat: Infinity }}>
        <circle cx="40" cy="70" r="2.5" fill="#D9A441" opacity="0.6" />
        <circle cx="80" cy="68" r="2.5" fill="#D9A441" opacity="0.6" />
        <circle cx="120" cy="70" r="2.5" fill="#D9A441" opacity="0.6" />
      </motion.g>
      {/* Shared garden on center island */}
      <ellipse cx="80" cy="88" rx="5" ry="3" fill="#7BA65B" opacity="0.4" />
