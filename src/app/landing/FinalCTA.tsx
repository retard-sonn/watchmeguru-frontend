...
export default function FinalCTA() {
  return (
    <section className="relative py-32 px-6 overflow-hidden" style={{ background: "linear-gradient(165deg, #5B4636 0%, #3D2E24 50%, #2B1F18 100%)" }}>
      {/* Warm atmospheric glow */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[60%] rounded-full"
          style={{ width: 500, height: 500, background: "radial-gradient(circle, rgba(217,164,65,0.18) 0%, transparent 65%)" }}
        />
        ...
        >
          ...
          <div className="flex justify-center mb-10">
            ...
            >
              ...
              <polygon points="150,120 260,140 150,160 40,140" fill="#7BA65B" opacity="0.4" />
              ...
              {/* Bigger trees */}
              <rect x="98" y="118" width="4" height="14" rx="1" fill="#5B4636" opacity="0.6" />
              <ellipse cx="100" cy="112" rx="12" ry="16" fill="#7BA65B" opacity="0.5" />
              <ellipse cx="100" cy="106" rx="8" ry="12" fill="#94A84D" opacity="0.5" />
              <rect x="198" y="122" width="4" height="14" rx="1" fill="#5B4636" opacity="0.6" />
              <ellipse cx="200" cy="116" rx="12" ry="16" fill="#7BA65B" opacity="0.5" />
              <ellipse cx="200" cy="110" rx="8" ry="12" fill="#94A84D" opacity="0.5" />
              {/* More buildings */}
              <rect x="125" y="128" width="40" height="24" rx="4" fill="#5B4636" opacity="0.4" />
              <rect x="185" y="126" width="30" height="26" rx="4" fill="#7A6554" opacity="0.4" />
              {/* Sun */}
              <circle cx="80" cy="40" r="18" fill="#D9A441" opacity="0.35" />
          ...
          >
            Set up your AI companion in 3 minutes. Get your first check-in today.
