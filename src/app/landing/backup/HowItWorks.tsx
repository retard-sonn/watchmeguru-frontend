...
const STEPS = [
  ...
  },
  {
    ...
    d: "We generate a daily plan. Roads form. Zones divide. Your terrain becomes an organized grid — structured but alive.",
    step: 2 as const,
  },
  {
    n: "3",
  ...
  {
    n: "4",
    t: "Smart verification",
    d: "The guardian chamber inspects your discipline. No cheating. The system reads patterns, detects gaps, adjusts intensity.",
    step: 4 as const,
  },
  {
    n: "5",
