...
const WORLDS = [
  ...
  },
  {
    ...
    desc: "A protected sanctuary where nothing enters. We build a wall between you and distractions.",
  },
  {
    label: "Momentum",
  ...
  },
  {
    ...
    desc: "An underground chamber. A lantern-lit cocoon. We know when you're truly locked in.",
  },
  {
    label: "XP System",
    variant: "xp" as const,
