    ...
    <section ref={sectionRef} className="py-24 px-6 relative overflow-hidden"
      ...
      <div ref={contentRef} className="relative z-10 max-w-2xl mx-auto text-center">
        <div ref={mascotRef} className="flex justify-center mb-8">
          <MascotPenguin className="w-32 h-32" state="celebrate" />
        </div>
        <h2 className="font-extrabold leading-[1.1] tracking-tight mb-6" style={{ fontFamily: "var(--font-baloo)", fontSize: "clamp(28px, 4.5vw, 48px)", color: "#F0FDF4" }}>
          Ready to <span style={{ color: "#58CC02" }}>level up</span> your study game?
        </h2>
        <p className="text-[16px] mb-10 max-w-md mx-auto font-medium" style={{ color: "rgba(240,253,244,0.65)" }}>
