            ...
            <div className="card-earthy p-6 flex flex-col items-center justify-center text-center" style={{ background: "linear-gradient(145deg, #F0FDF4 0%, #E8FFE8 100%)" }}>
              <div className="mb-4">
                <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: "linear-gradient(135deg, #58CC02, #46A302)", boxShadow: "0 8px 32px rgba(88,204,2,0.35)" }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M6 4L18 12L6 20V4Z" fill="#F0FDF4" /></svg>
                </div>
              </div>
                  ...
                  {WEEK.map((day, i) => (
                    <div key={day} className="flex flex-col items-center gap-2">
                      ...
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                        style={{ background: COMPLETED[i] ? "linear-gradient(135deg, #FF9E1B, #5F8C3E)" : "rgba(26,58,10,0.05)" }}>
                        {COMPLETED[i] ? (
                          <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7L5.5 9.5L11 4" stroke="#F0FDF4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
